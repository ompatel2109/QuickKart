//admin main page right side info
    ...
    return (
        <div className='max-w-7xl mx-auto p-6'>
            ...
            {productsLoading || ordersLoading ? (
                ...
                <p className='text-red-500'>Error fetcching products: {productsError}</p>
            ) : ordersError ? (
                <p className='text-red-500'>Error fetcching orders: {ordersError}</p>
            ) : (
