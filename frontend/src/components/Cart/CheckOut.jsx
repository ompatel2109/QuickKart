...
const CheckOut = () => {
    ...
    const handleCreateCheckout = async (e) => {
        ...
        if(res.payload && res.payload._id){
            setCheckoutId(res.payload._id);//set checkout id if checkout succesfull
        }
        }
    }
    ...
    const handlePaymentSuccess = async (details) => {
        try {
            const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/checkout/${checkoutId}/pay`, 
                ...
                await handleFinalizeCheckout(checkoutId);//finalize checkout if successfull
        ...
        tracking-tighter'>
            <div className="bg-white rounded-lg p-6 ">
                ...
                <form onSubmit={handleCreateCheckout}>
                    ...
                    <div className="mt-6">
                        {!checkoutId ? (
                            <button type='submit' className='w-full bg-black text-white py-3 cursor-pointer rounded'>Continue to Payment</button>
                        ) : (
                            <div>
