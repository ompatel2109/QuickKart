        ...
        <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md '>
            ...
            <form onSubmit={handleSubmit}>{/*Name */}
                ...
                <div className='mb-6'>
                    ...
                    className="block w-full text-sm text-gray-500 file:py-1 file:px-4
                    file:rounded file:border-1 file:text-sm file:font-semibold
                    file:bg-gray-200 file:text-black file:cursor-pointer
                ...
                <button type='submit'
                className='w-full bg-green-500 cursor-pointer text-white py-2 rounded-md hover:bg-green-600 transition-colors'>Update Product</button>     
            </form>
        </div>
    )
}
